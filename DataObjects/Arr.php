...
class Arr
{
     ...
     * @throws InvalidArgumentException
     */
    // Deliberately untyped, as upstream leaves it. The union that was here
    // excluded plain objects, which made the is_object() branch below
    // unreachable and rejected a Closure that getArrayableItems() passes
    // straight through.
